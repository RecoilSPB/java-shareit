...
public class RequestControllerTest {
    ...
    public void testGetYourRequests() throws Exception {
        List<RequestDto> requests = Collections.singletonList(RequestDto.builder().id(1L).description("Request1").build());
    ...
    public void testAddRequest() throws Exception {
        RequestDto requestDto = RequestDto.builder().id(1L).description("NewRequest").build();
        ...
        verify(requestService, times(1)).addRequest(anyLong(), any(RequestDto.class));
    }
    ...
    public void testGetRequestById() throws Exception {
        RequestDto requestDto = RequestDto.builder().id(1L).description("Request1").build();
